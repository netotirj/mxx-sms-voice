    ...
    private const DEFINITIONS = [
        'users' => [
            ...
            'routes' => [
                ...
                ['type' => 'exact', 'match' => '/users', 'features' => ['administrative']],
                ['type' => 'exact', 'match' => '/users/new', 'features' => ['administrative', 'create_users']],
                ['type' => 'prefix', 'match' => '/users/search', 'features' => ['administrative']],
                ['type' => 'prefix', 'match' => '/users/{id}/edit', 'features' => ['administrative', 'create_users']],
                ['type' => 'prefix', 'match' => '/users/edit', 'features' => ['administrative', 'create_users']],
                ['type' => 'prefix', 'match' => '/users/{id}/delete', 'features' => ['administrative', 'create_users']],
                ['type' => 'prefix', 'match' => '/users/up-status', 'features' => ['administrative', 'create_users']],
                ['type' => 'prefix', 'match' => '/users/refills', 'features' => ['administrative', 'create_users']],
            ],
        ],
        'rates' => [
            'label' => 'Tarifas',
        ...
        'permissions' => [
            ...
            'routes' => [
                ['type' => 'exact', 'match' => '/permissions', 'features' => ['administrative']],
                ['type' => 'prefix', 'match' => '/permissions/', 'features' => ['administrative']],
            ],
        ],
        'reports' => [
            'label' => 'Relatorios',
        ...
        'administrative' => [
            ...
            'features' => ['administrative'],
            'permissions' => ['/users', '/permissions', '/refills', '/notifications', '/plans', '/support', '/system-updates', '/admin/services-monitor', '/global-costs', '/admin/platform-consumption'],
