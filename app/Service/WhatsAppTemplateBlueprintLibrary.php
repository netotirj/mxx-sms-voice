...
class WhatsAppTemplateBlueprintLibrary
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            ['key' => 'utility_protocolo_atendimento', 'name' => 'util_protocolo_atendimento_01', 'category' => 'UTILITY', 'language' => 'pt_BR', 'body' => 'Olá {{1}}, seu protocolo de atendimento é: {{2}}. Guarde esta mensagem para referência.', 'variables' => [self::v(1, 'nome_cliente', 'Nome do cliente', 'text', 'system', 'Preenchido automaticamente pelo sistema no envio do protocolo.'), self::v(2, 'protocolo_atendimento', 'Protocolo do atendimento', 'text', 'system', 'Gerado automaticamente pelo sistema no momento do atendimento.')]],
