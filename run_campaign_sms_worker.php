...
use App\Service\SmsCampaignQueueWorker;
...
$workerName = getenv('CAMPAIGN_SMS_WORKER_SERVICE_NAME') ?: 'maxx-campaign-sms-worker.service';

try {
    $summary = (new SmsCampaignQueueWorker())->runOnce($limit, $workerName);

    WorkerHeartbeat::record(
        $workerName,
        'campaign_sms',
        'running',
        'Execucao do worker da fila persistente de SMS.',
