...
public static function getLastBatchByUser(int $userId, string $tenancyId): ?CampaignBatch1604
{
    $query = "
    ...
    $result = (new Database())->execute($query, $params)->fetchObject(CampaignBatch1604::class);

    return $result instanceof CampaignBatch1604 ? $result : null;
}
