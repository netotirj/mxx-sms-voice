...
class WhatsAppTemplateBlueprintLibrary
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            ['key' => 'utility_protocolo_atendimento', 'name' => 'util_confirmacao_atendimento_01', 'category' => 'UTILITY', 'language' => 'pt_BR', 'body' => 'Olá {{1}}, seu atendimento {{2}} foi registrado em nosso sistema. Esta é uma confirmação automática.', 'variables' => [self::v(1, 'nome_cliente', 'Nome do cliente'), self::v(2, 'protocolo_atendimento', 'Protocolo do atendimento')]],
