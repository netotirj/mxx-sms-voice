...
class RegisterTenancies
{
    ...
    public static function deleteTenancyTree(string $tenancyId): array
    {
        ...
        try {
            ...
            self::deleteByColumn($db, $summary, 'whatsapp_call_cdr', 'tenancy_id', $tenancyId);
            self::deleteByColumn($db, $summary, 'whatsapp_call_permissions', 'tenancy_id', $tenancyId);
            self::deleteByColumn($db, $summary, 'whatsapp_template_event_logs', 'tenancy_id', $tenancyId);
            self::deleteByColumn($db, $summary, 'whatsapp_template_audit_logs', 'tenancy_id', $tenancyId);
            ...
            self::deleteByColumn($db, $summary, 'pix_api_logs', 'tenancy_id', $tenancyId);
            ...
            self::deleteByColumn($db, $summary, 'financial_hierarchy_logs', 'tenancy_id', $tenancyId);
            self::deleteByColumn($db, $summary, 'financial_transaction_ledger', 'tenancy_id', $tenancyId);
            self::deleteByColumn($db, $summary, 'asterisk_balance_sync_queue', 'tenancy_id', $tenancyId);
            self::deleteByColumn($db, $summary, 'manual_balance_topup_audit', 'target_tenancy_id', $tenancyId);
            self::deleteByColumn($db, $summary, 'manual_balance_topup_audit', 'actor_tenancy_id', $tenancyId);
            self::deleteByColumn($db, $summary, 'marketing_campaign_assets', 'tenancy_id', $tenancyId);
            self::deleteByColumn($db, $summary, 'marketing_campaign_audiences', 'tenancy_id', $tenancyId);
            self::deleteByColumn($db, $summary, 'marketing_campaign_budgets', 'tenancy_id', $tenancyId);
            self::deleteByColumn($db, $summary, 'marketing_campaign_history', 'tenancy_id', $tenancyId);
            self::deleteByColumn($db, $summary, 'marketing_campaign_metrics', 'tenancy_id', $tenancyId);
            self::deleteByColumn($db, $summary, 'marketing_campaigns', 'tenancy_id', $tenancyId);
            self::deleteByColumn($db, $summary, 'marketing_meta_settings', 'tenancy_id', $tenancyId);
            self::deleteByColumn($db, $summary, 'marketing_meta_sync_logs', 'tenancy_id', $tenancyId);
            self::deleteByColumn($db, $summary, 'service_monitor_audit_logs', 'tenancy_id', $tenancyId);
            ...
            self::deleteByColumn($db, $summary, 'sys_permission_cache_versions', 'tenancy_id', $tenancyId);
