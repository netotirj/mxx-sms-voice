...
$workerName = getenv('CAMPAIGN_SCHEDULER_SERVICE_NAME') ?: 'maxx-campaign-scheduler.service';

try {
    $summary = (new CampaignSchedulerService())->runScheduler($limit, $workerName);

    WorkerHeartbeat::record(
        $workerName,
        'campaign_scheduler',
        'running',
        'Execucao do scheduler central de campanhas.',
